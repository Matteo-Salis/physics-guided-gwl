...
def weight_init_ortho_alt(model,
                        ...
                        no_act_layers=["Value_Embedding_GW",
                                ...
                                "Output_Delta_S"],
                        tanh_layers = []):
    # weight ortho initialization alternative
...
def weight_init_He_alt(model,
                        ...
                        linear_layers=["Value_Embedding_GW",
                                ...
                                "Output_Delta_GW",
                                "Output_Delta_S"]):
    # weight He initialization alternative
...
class FiLM_conditioning(nn.Module):
    # FiLM conditioning as in Perez et al. (2017)
